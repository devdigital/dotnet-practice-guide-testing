...
If you group tests based on their type into separate project, then you're likely to have different structures and references per test type. For example, an integration test may need to write to a database, in which case you may have references to an ORM or a folder for database helper classes. 
